...
public class DataFileUtilClient {
     ...
     * validity.
     */
    public DataFileUtilClient(AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public DataFileUtilClient(String user, String password) throws UnauthorizedException, IOException {
