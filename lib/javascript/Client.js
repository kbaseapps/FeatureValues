...
function KBaseFeatureValues(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax("KBaseFeatureValues._check_job", 
     ...
     this.estimate_k_new = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("KBaseFeatureValues.estimate_k_new",
            [params], 1, _callback, _errorCallback);
    };
     ...
     this.build_feature_set = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("KBaseFeatureValues.build_feature_set",
            [params], 1, _callback, _errorCallback);
    };
